...
IK.Joint = function(name, lname, length, angle) {
...
IK.Node.prototype.append = function(joint) {
...
// in anyway.
IK.Node.prototype.remove = function(joint) {
...
IK.Node.prototype.bfs = function(f) {
...
IK.Node.prototype.bfsFindNode = function(name) {
...
// The traverse terminates when all nodes in this hierarchy are accessed or
// whenever the given function returns 'false'.
IK.Node.prototype.dfs = function(f) {
...
IK.Node.prototype.getRootTrans = function() {
...
IK.Node.prototype.getRootCoordPos = function() {
...
IK.Node.prototype.stepIk = function(pos, dt) {
